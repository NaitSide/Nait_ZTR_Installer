...
NAIT_ZTR_INSTALLER_VERSION="0.6.0"
NAIT_ZTR_DEFAULT_NETWORK_NAME="ztr_net"
NAIT_ZTR_DEFAULT_NETWORK_CIDR="10.0.1.0/24"
NAIT_ZTR_DEFAULT_CORE_IP="10.0.1.1"
NAIT_ZTR_CONFIG_DIR="/etc/naitlab/zerotier"
NAIT_ZTR_CONFIG_FILE="${NAIT_ZTR_CONFIG_DIR}/zerotier.env"
NAIT_ZTR_CONTROLLER_MARKER="${NAIT_ZTR_CONFIG_DIR}/controller.enabled"
NAIT_ZTR_MOON_CONFIG_DIR="${NAIT_ZTR_CONFIG_DIR}/moon"
NAIT_ZTR_MOON_CONFIG_FILE="${NAIT_ZTR_MOON_CONFIG_DIR}/moon.json"
NAIT_ZTR_MOONS_DIR="/var/lib/zerotier-one/moons.d"
NAIT_ZTR_MOON_PORT="9993"
...
NAIT_ZTNCUI_CONTAINER_NAME="ztncui_box"
NAIT_ZTNCUI_CONTAINER_DIR="/opt/naitlab/ztncui_box"
NAIT_ZTNCUI_CONTAINER_DATA_DIR="${NAIT_ZTNCUI_CONTAINER_DIR}/data"
NAIT_ZTNCUI_CONTAINER_ENV_FILE="${NAIT_ZTNCUI_CONTAINER_DIR}/.env"
NAIT_ZTNCUI_CONTAINER_COMPOSE_FILE="${NAIT_ZTNCUI_CONTAINER_DIR}/docker-compose.yml"
NAIT_ZTNCUI_CONTAINER_IMAGE="naitlab/ztncui:${NAIT_ZTNCUI_DEFAULT_VERSION}"
